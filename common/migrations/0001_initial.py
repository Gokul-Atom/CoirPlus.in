# Generated by Django 5.2.12 on 2026-03-13 16:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt_text', models.CharField(blank=True, help_text='Alternative text for accessibility; describe what is in the image.', max_length=255, null=True, verbose_name='Alt text')),
                ('caption', models.CharField(blank=True, help_text='Caption text; will be shown below the image.', max_length=255, null=True, verbose_name='Caption')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='renditions', to='common.myimage')),
            ],
            options={
